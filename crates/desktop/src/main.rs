...
use std::sync::Arc;
use ui::actions::{
    CloseWindow, Copy, Cut, DeleteObject, DownloadObject, OpenCommandPalette, Paste, PreviewObject,
    Quit, Redo, Refresh, SelectAll, ToggleInspector, ToggleSidebar, Undo, UploadFiles,
    UploadFolder,
};

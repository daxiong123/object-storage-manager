...
use crate::actions::{
    AddAccount, CloseWindow, DeleteObject, DownloadObject, PaletteClose, PaletteSelectNext,
    PaletteSelectPrev, PreviewObject, Quit, Refresh, ToggleInspector, ToggleSidebar, UploadFiles,
    UploadFolder,
};
